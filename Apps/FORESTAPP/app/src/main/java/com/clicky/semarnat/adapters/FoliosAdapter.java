...
import com.clicky.semarnat.data.Folio;
 ...
 *
 */
public class FoliosAdapter extends ArrayAdapter<Folio> {

    private Context context;
    private int resource;
    private List<Folio> items, orig;

    public FoliosAdapter(Context context, int resource, List<Folio> items) {
